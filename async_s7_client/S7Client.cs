    ...
    public class S7Client {
        ...
        public async Task<bool> ConnectAsync() {
            ...
            try {
                ...
                await networkStream.WriteAsync(isoConnectionRequest, 0, isoConnectionRequest.Length);
                int receivedByteCount = await networkStream.ReadAsync(response, 0, response.Length);
                ...
                await networkStream.WriteAsync(pduNegotiationRequest, 0, pduNegotiationRequest.Length);
                receivedByteCount = await networkStream.ReadAsync(response, 0, response.Length);
        ...
        public async Task<byte[]> ReadAsync(ushort dataBlockNumber, uint startingAddress, ushort byteCount) {
            ...
            await networkStream.WriteAsync(readRequest, 0, readRequest.Length);
            int receivedByteCount = await networkStream.ReadAsync(response, 0, response.Length);
        ...
        public async Task<bool> WriteAsync(ushort dataBlockNumber, uint startingAddress, byte[] bytesToWrite) {
            ...
            await networkStream.WriteAsync(writeRequest, 0, writeRequest.Length);
            int receivedByteCount = await networkStream.ReadAsync(response, 0, response.Length);
